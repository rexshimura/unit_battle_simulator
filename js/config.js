...
const UNIT_ROLES = {
    ...
    Interceptors: ['fortress', 'guardian', 'rockgolem'],
...
const UNIT_SPECS = {
  ...
  'cryomancer': {description: 'Slows and freezes enemies', name: 'Cryomancer', hp: 80, speed: 0.6, attackDamage: 15, attackRange: 300, attackCooldown: 800, color: {team1: '#60a5fa', team2: '#f87171'}, specialTriggerCount: 3, waveDamage: 3, freezeStacksApplied: 1, freezeTriggerCount: 4, freezeDuration: 2500, chillDuration: 5000}, 
